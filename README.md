...
ระบบหลังร้านสำหรับร้านเช่าชุด Precious Shop รุ่น V1 Customer Module

## Features

- หน้า `รายชื่อลูกค้า` ภาษาไทยตาม dark dashboard reference
...
1. รัน SQL ใน `supabase/migrations/0001_customer_module.sql`
