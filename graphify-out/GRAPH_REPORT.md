...
## Corpus Check
- 118 files · ~113,933 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1549 nodes · 3096 edges · 72 communities (62 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `85acf7e3`
...
Cohesion: 0.01
Nodes (123): activeCustomers, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs], [authUserEmail, setAuthUserEmail], [authUserId, setAuthUserId], authUserIdRef, [availableShops, setAvailableShops] (+115 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (89): TextField(), archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CUSTOMER_SUMMARY_SELECT, CustomerDocumentRow (+81 more)
...
Cohesion: 0.05
Nodes (37): allCostumesHaveSelectedTier, [basePriceFromTier, setBasePriceFromTier], disc, [editFormError, setEditFormError], [editingRentalId, setEditingRentalId], [editMode, setEditMode], [extraFineAmount, setExtraFineAmount], [extraFineError, setExtraFineError] (+29 more)
...
Cohesion: 0.09
Nodes (39): [collectedAmount, setCollectedAmount], costumeContainerRef, costumeImageUrl, [costumeSearch, setCostumeSearch], [currentPage, setCurrentPage], customerContainerRef, [customerSearch, setCustomerSearch], [depositAmount, setDepositAmount] (+31 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (33): allocateFineAmount(), DepositAllocation, DepositAllocationInput, DepositResolutionDraft, FineAllocation, FineAllocationInput, fromCents(), normalizeCurrencyAmount() (+25 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (37): 1. Database & Migrations, 📂 1. Database & Schema, 🌟 1. ฟีเจอร์ใหม่: ตั้งค่าระบบราคาและค่าปรับเริ่มต้นส่วนกลาง (Global Rental Defaults), 1. Interactive KPI Dashboard (ส่วนบน), 💰 2. ระบบ Auto-Pass สรุปเคสไร้มัดจำ และ Extra Fine Workflow, 📡 2. Data Access Layer (Remote), 2. Hybrid Table / Mini-Card List (แผงด้านซ้าย), 2. TypeScript Types & Core APIs (+29 more)
...
Cohesion: 0.09
Nodes (27): createRemoteRental(), createRemoteRentals(), deleteRemoteRental(), loadRentals(), mapRentalRow(), RentalDepositResolutionUpdate, RentalFineUpdate, RentalRow (+19 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (21): buildCatalogSizeSummary(), CatalogSizeSummary, customer, stockItems, summary, FlatStockItem, Product, ProductWithStockSummary (+13 more)
...
Cohesion: 0.12
Nodes (27): bulkUpdateRemoteDisplayOrder(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), countRemoteRentalsForProduct(), createProductImageDisplayUrl(), createProductWithVariants(), createSignedStorageUrl() (+19 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (15): addStockToVariant(), countRemoteRentalsForStockItem(), loadProductsWithStock(), updateRemoteProductPublicVisibility(), updateRemoteStockItemPublicVisibility(), updateRemoteStockItemStatus(), emptyProductDraft, emptyStockDraft (+7 more)
...
Cohesion: 0.18
Nodes (24): deleteShopHeroImage(), updateShopSettings(), cloneRentalPriceTiers(), ensureCustomerDocumentPreview(), ensureExistingDocumentPreview(), fileToDataUrl(), getErrorMessage(), getShopSettings() (+16 more)
...
Cohesion: 0.17
Nodes (18): [brandError, setBrandError], [brandSuccess, setBrandSuccess], [categoryError, setCategoryError], [categorySuccess, setCategorySuccess], [colorError, setColorError], [colorSuccess, setColorSuccess], handleAddBrandSubmit(), handleAddCategorySubmit() (+10 more)

### Community 27 - "Community 27"
Cohesion: 0.25
Nodes (18): cleanupUnusedImages(), countRemoteRentalsForStockSku(), createRemoteStockItem(), createRemoteStockItems(), dataURLtoFile(), deleteRemoteStockItem(), getPathFromUrl(), loadStockItems() (+10 more)
...
Cohesion: 0.18
Nodes (12): Customer, customer, makeRental(), metrics, stockItem, demoRentals, demoStockItemsForRentals, RentalOrder (+4 more)

### Community 30 - "Community 30"
Cohesion: 0.12
Nodes (17): allocateForfeitedDeposit(), saveExtraFine(), updateRemoteRentalDeposit(), updateRemoteRentalDepositResolution(), updateRemoteRentalFields(), canDeleteRentalGroup(), getAllowedRentalEditFields(), handleCancelRental() (+9 more)

### Community 31 - "Community 31"
Cohesion: 0.23
Nodes (14): getInventoryDisplayStatus(), item, itemRepair, itemWash, makeRental(), makeStockItem(), rentals, rentalsActive (+6 more)
...
Cohesion: 0.67
Nodes (3): parseMoneyInput(), syncCollectedAmount(), syncDiscountAmount()

## Knowledge Gaps
- **590 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+585 more)
...
- **Why does `uploadProductImages()` connect `Community 19` to `Community 28`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 28`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 28`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
