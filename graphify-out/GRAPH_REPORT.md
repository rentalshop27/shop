...
## Corpus Check
- 92 files · ~98,666 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1324 nodes · 2699 edges · 62 communities (54 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `083fc4da`
...
Cohesion: 0.05
Nodes (87): TextField(), archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CustomerDocumentRow, CustomerRow (+79 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (74): calculateReturnDate(), findConflictingRentalForStockSku(), findOpenRentalConflict(), findOpenRentalForStockSku(), hasRentalConflict(), isDateOverlap(), isOpenRental(), isOpenRentalStatus() (+66 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (66): buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, customer, makeRental(), metrics (+58 more)
...
Cohesion: 0.07
Nodes (25): [activeStatusDropdownId, setActiveStatusDropdownId], baseSku, count, [currentPage, setCurrentPage], currentProducts, fileInputRef, filteredItems, InventoryPageProps (+17 more)
...
Cohesion: 0.13
Nodes (20): createRemoteRental(), createRemoteRentals(), deleteRemoteRental(), loadRentals(), mapRentalRow(), RentalRow, customer, deleteQuery (+12 more)
...
Cohesion: 0.2
Nodes (22): deleteShopHeroImage(), removeShopAssetPaths(), updateShopSettings(), uploadShopHeroImage(), ensureCustomerDocumentPreview(), ensureExistingDocumentPreview(), fileToDataUrl(), getErrorMessage() (+14 more)
...
Cohesion: 0.11
Nodes (10): InventoryControllerPageProps, countRemoteRentalsForStockItem(), updateRemoteProductPublicVisibility(), updateRemoteStockItemPublicVisibility(), emptyProductDraft, emptyStockDraft, NormalizedStockDraft, normalizeProductDraft() (+2 more)
...
Cohesion: 0.19
Nodes (16): addStockToVariant(), cleanupDeletedProductImagePaths(), cleanupUploadedProductImagePaths(), countRemoteRentalsForProduct(), createProductWithVariants(), createSignedStorageUrl(), deleteRemoteProduct(), extractCostumeStoragePath() (+8 more)
...
Cohesion: 0.16
Nodes (13): getInventoryDisplayStatus(), Product, ProductDraft, ProductWithStockSummary, RentalTier, SizeVariant, StockItemStatus, StockItemWithProduct (+5 more)
...
Cohesion: 0.33
Nodes (6): FlatStockItem, StockItem, demoFlatStockItemsForRentals, demoRentals, demoStockItemsForRentals, StockItem
...
## Knowledge Gaps
- **469 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+464 more)
...
- **Why does `uploadProductImages()` connect `Community 24` to `Community 21`?**
