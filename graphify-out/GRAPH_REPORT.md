...
## Corpus Check
- 108 files · ~108,970 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1470 nodes · 2959 edges · 70 communities (64 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1951a47b`
...
Cohesion: 0.11
Nodes (30): bulkUpdateRemoteDisplayOrder(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), countRemoteRentalsForStockItem(), createProductImageDisplayUrl(), createProductWithVariants(), createSignedStorageUrl() (+22 more)
...
Cohesion: 0.18
Nodes (15): customer, getTodayString(), makeRental(), makeStockItem(), onUpdateRentalStatus, user, customer, makeRental() (+7 more)

### Community 25 - "Community 25"
Cohesion: 0.18
Nodes (14): buildCatalogSizeSummary(), CatalogSizeSummary, customer, stockItems, summary, getInventoryDisplayStatus(), FlatStockItem, Product (+6 more)

### Community 26 - "Community 26"
Cohesion: 0.1
Nodes (11): addStockToVariant(), countRemoteRentalsForProduct(), updateRemoteProductPublicVisibility(), updateRemoteStockItemPublicVisibility(), updateRemoteStockItemStatus(), emptyProductDraft, emptyStockDraft, NormalizedStockDraft (+3 more)
...
- **Why does `uploadProductImages()` connect `Community 12` to `Community 14`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 14`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 19`, `Community 14`?**
