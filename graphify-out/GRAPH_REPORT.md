...
## Corpus Check
- 53 files · ~80,117 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 780 nodes · 1743 edges · 34 communities (27 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1339fd91`
...
Cohesion: 0.02
Nodes (87): activeCustomers, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs], [authUserId, setAuthUserId], [availableShops, setAvailableShops], baseSku, [brands, setBrands] (+79 more)
...
Cohesion: 0.08
Nodes (45): customer, getTodayString(), makeRental(), makeStockItem(), onUpdateRentalStatus, user, OverviewShopData, costume (+37 more)
...
Cohesion: 0.08
Nodes (43): ShopSummary, buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, customer, makeRental() (+35 more)
...
## Knowledge Gaps
- **172 isolated node(s):** `emptyDraft`, `ViewKey`, `StockDraft`, `emptyStockDraft`, `DEFAULT_BRANDS` (+167 more)
...
- **Why does `RentalOrder` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 16`, `Community 17`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `Customer` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 16`, `Community 17`, `Community 19`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `StockItem` connect `Community 3` to `Community 0`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 16`, `Community 17`, `Community 19`?**
