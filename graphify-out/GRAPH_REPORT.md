...
## Corpus Check
- 93 files · ~97,404 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1206 nodes · 2500 edges · 55 communities (51 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bac20721`
...
Cohesion: 0.09
Nodes (27): buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, toUtcDay(), aggregatedMetrics, allRentals (+19 more)
...
Cohesion: 0.18
Nodes (15): customer, makeRental(), metrics, stockItem, StockItem, StockItemStatus, demoRentals, demoStockItemsForRentals (+7 more)
...
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 18`, `Community 19`?**
