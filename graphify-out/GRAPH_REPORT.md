...
## Corpus Check
- 92 files · ~98,577 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1321 nodes · 2692 edges · 63 communities (55 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57792aa8`
...
Cohesion: 0.15
Nodes (17): FlatStockItem, Product, ProductDraft, ProductWithStockSummary, SizeVariant, StockItemStatus, StockItemWithProduct, { primaryStatus } (+9 more)
...
Cohesion: 0.12
Nodes (9): InventoryPageProps, countRemoteRentalsForProduct(), updateRemoteStockItemPublicVisibility(), emptyProductDraft, emptyStockDraft, NormalizedStockDraft, normalizeProductDraft(), normalizeStockDraft() (+1 more)
...
Cohesion: 0.14
Nodes (15): InventoryPageContainer(), [currentStockItems, setCurrentStockItems], [isSaving, setIsSaving], stockItems, user, StockItem, InventoryControllerOptions, [currentStockItems, setCurrentStockItems] (+7 more)

### Community 26 - "Community 26"
Cohesion: 0.18
Nodes (17): addStockToVariant(), cleanupDeletedProductImagePaths(), cleanupUploadedProductImagePaths(), countRemoteRentalsForStockItem(), createProductWithVariants(), createSignedStorageUrl(), deleteRemoteProduct(), extractCostumeStoragePath() (+9 more)
...
## Knowledge Gaps
- **467 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+462 more)
...
- **Why does `uploadProductImages()` connect `Community 26` to `Community 23`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 50`, `Community 23`?**
