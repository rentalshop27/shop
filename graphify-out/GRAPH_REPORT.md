# Graph Report - Precious-Shop-Test  (2026-07-02)

## Corpus Check
- 88 files · ~95,524 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1287 nodes · 2652 edges · 61 communities (54 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de493ab0`
...
Cohesion: 0.01
Nodes (118): activeCustomers, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs], [authUserEmail, setAuthUserEmail], [authUserId, setAuthUserId], authUserIdRef, [availableShops, setAvailableShops] (+110 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (80): TextField(), archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CustomerDocumentRow, CustomerRow (+72 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (77): ProductDraft, addStockToVariant(), cleanupDeletedProductImagePaths(), cleanupUnusedImages(), cleanupUploadedProductImagePaths(), countRemoteRentalsForProduct(), countRemoteRentalsForStockItem(), countRemoteRentalsForStockSku() (+69 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (62): ShopSummary, buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, toUtcDay(), [activeContactUser, setActiveContactUser] (+54 more)
...
Nodes (39): {
    ...
    transition,
    isDragging
  }, availability, availabilityCounts, [availabilityFilter, setAvailabilityFilter], [brandFilter, setBrandFilter], brands, canEditHeroBackground, CatalogAvailabilityFilter (+31 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (37): additionalURLs, addRoute(), cacheMatchIgnoreParams(), _cacheNameDetails, cacheNames, cacheWillUpdate(), canConstructResponseFromBodyStream(), cleanupOutdatedCaches() (+29 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (35): DateRangeMode, DressReportItem, activeDateRange, [activeSubTab, setActiveSubTab], [brandFilter, setBrandFilter], brandsList, categoriesList, categoryChartColors (+27 more)
...
Cohesion: 0.08
Nodes (29): addMonths(), buildDressReportsData(), buildGeneralStoreMetrics(), buildMonthlyDepositSummary(), buildMonthlyRevenueTrends(), buildMonthRange(), buildReportsDateRange(), buildRevenueByCategory() (+21 more)
...
Cohesion: 0.2
Nodes (22): deleteShopHeroImage(), removeShopAssetPaths(), updateShopSettings(), uploadShopHeroImage(), archiveSelectedCustomer(), fileToDataUrl(), getErrorMessage(), getShopSettings() (+14 more)

### Community 18 - "Community 18"
Cohesion: 0.17
Nodes (18): handleLogout(), buildGoogleOAuthStartUrl(), getGoogleOAuthCallbackUrl(), getGoogleOAuthClientId(), getGoogleOAuthReturnUrl(), getGoogleOAuthSetupState(), readEnv(), trimTrailingSlash() (+10 more)
...
Cohesion: 0.18
Nodes (14): FlatStockItem, Product, ProductWithStockSummary, SizeVariant, StockItem, StockItemStatus, StockItemWithProduct, { primaryStatus } (+6 more)
...
Cohesion: 0.29
Nodes (8): customer, makeRental(), metrics, stockItem, RentalOrder, RentalStatus, StockItem, StockItemStatus
...
Cohesion: 0.25
Nodes (8): [currentStockItems, setCurrentStockItems], [isSaving, setIsSaving], { pageProps }, [shopId, setShopId], stockItems, TestHarness(), user, useInventoryController()
...
Cohesion: 0.67
Nodes (3): getDaysBetween(), getOverlapDays(), toUtcDay()

## Knowledge Gaps
- **447 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+442 more)
...
- **Why does `uploadProductImages()` connect `Community 2` to `Community 14`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 14`?**
