# Graph Report - Precious-Shop-Test  (2026-06-21)

## Corpus Check
- 74 files · ~87,618 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 980 nodes · 2137 edges · 37 communities (31 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d602d844`
...
Cohesion: 0.06
Nodes (70): customer, getTodayString(), makeRental(), makeStockItem(), onUpdateRentalStatus, user, getInventoryDisplayStatus(), item (+62 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (70): archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CustomerDocumentRow, CustomerRow, deleteGoogleDriveCustomerDocuments() (+62 more)
...
Cohesion: 0.09
Nodes (44): StockItemStatus, cleanupUnusedImages(), countRemoteRentalsForStockSku(), createRemoteStockItem(), createRemoteStockItems(), dataURLtoFile(), deleteRemoteStockItem(), getPathFromUrl() (+36 more)
...
Cohesion: 0.05
Nodes (36): [activeStatusDropdownId, setActiveStatusDropdownId], baseSku, count, fileInputRef, filteredItems, InventoryPageProps, InventorySummary, match (+28 more)
...
## Knowledge Gaps
- **272 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+267 more)
...
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 2` to `Community 15`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 2` to `Community 27`, `Community 15`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `deleteGoogleDriveCustomerDocuments()` connect `Community 2` to `Community 15`?**
