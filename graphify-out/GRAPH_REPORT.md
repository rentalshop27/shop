# Graph Report - Precious-Shop-Test  (2026-07-01)

## Corpus Check
- 84 files · ~93,179 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1255 nodes · 2602 edges · 60 communities (54 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f13918d9`
...
Cohesion: 0.05
Nodes (82): TextField(), archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CustomerDocumentRow, CustomerRow (+74 more)
...
Cohesion: 0.05
Nodes (32): availability, availabilityCounts, [availabilityFilter, setAvailabilityFilter], [brandFilter, setBrandFilter], brands, canEditHeroBackground, CatalogAvailabilityFilter, CatalogAvailabilityStatus (+24 more)
...
Cohesion: 0.14
Nodes (26): canReuseExistingToken, error, refreshToken, supabase, url, authUrl, url, appendResult() (+18 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (21): InventoryControllerPageProps, InventoryPageProps, addStockToVariant(), countRemoteRentalsForProduct(), countRemoteRentalsForStockItem(), createProductWithVariants(), deleteRemoteProduct(), loadProductsWithStock() (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.11
Nodes (24): createSignedUrl, deletedIds, deleteFilterQuery, deleteFilters, deleteQuery, eq, file, filters (+16 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (20): [activeStatusDropdownId, setActiveStatusDropdownId], baseSku, count, fileInputRef, filteredItems, InventorySummary, match, newVariants (+12 more)
...
Cohesion: 0.21
Nodes (6): executeQuotaErrorCallbacks(), PrecacheStrategy, StrategyHandler, timeout(), toRequest(), waitUntil()
...
Cohesion: 0.22
Nodes (13): FlatStockItem, StockItem, createRemoteRental(), loadRentals(), mapRentalRow(), RentalRow, toRentalInsert(), demoFlatStockItemsForRentals (+5 more)
...
Cohesion: 0.2
Nodes (10): Product, ProductDraft, ProductWithStockSummary, SizeVariant, StockItemStatus, StockItemWithProduct, { primaryStatus }, SIZES (+2 more)
...
Cohesion: 0.4
Nodes (6): createSignedStorageUrl(), deleteShopHeroImage(), getPathFromUrl(), loadShopSettings(), removeShopAssetPaths(), uploadShopHeroImage()
...
## Knowledge Gaps
- **425 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+420 more)
...
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 18`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `deleteGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 18`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 49`, `Community 18`?**
