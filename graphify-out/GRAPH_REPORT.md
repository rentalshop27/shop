...
## Corpus Check
- 37 files · ~67,698 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 543 nodes · 1095 edges · 26 communities (21 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8e0b62a`
...
Cohesion: 0.08
Nodes (48): findOpenRentalConflict(), findOpenRentalForStockSku(), [collectedAmount, setCollectedAmount], costumeContainerRef, costumeImageUrl, [costumeSearch, setCostumeSearch], [currentPage, setCurrentPage], customerContainerRef (+40 more)

### Community 4 - "Community 4"
Cohesion: 0.12
Nodes (37): archiveRemoteCustomer(), createRemoteCustomer(), CustomerDocumentRow, CustomerRow, deleteRemoteCustomerDocuments(), loadCustomers(), loadOwnerShopId(), mapCustomerRow() (+29 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (30): customer, metrics, stockItem, createRemoteRental(), createRemoteRentals(), deleteRemoteRental(), loadRentals(), mapRentalRow() (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.17
Nodes (6): getFriendlyURL(), PrecacheStrategy, Strategy, StrategyHandler, timeout(), toRequest()

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (25): buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, toUtcDay(), [activeContactUser, setActiveContactUser], [activeSlipToReview, setActiveSlipToReview] (+17 more)
...
Cohesion: 0.19
Nodes (20): cleanupUnusedImages(), countRemoteRentalsForStockSku(), createRemoteStockItem(), dataURLtoFile(), deleteRemoteStockItem(), getPathFromUrl(), loadShopSettings(), loadStockItems() (+12 more)
...
Cohesion: 0.29
Nodes (7): closeStockForm(), closeStockPreview(), handleDeleteRental(), handleDeleteStockItem(), handleLoadAuditLogs(), handleUpdateRentalStatus(), refreshAuditLogs()
...
## Knowledge Gaps
- **123 isolated node(s):** `emptyDraft`, `ViewKey`, `StockDraft`, `emptyStockDraft`, `statusOptions` (+118 more)
...
- **Why does `RentalOrder` connect `Community 5` to `Community 1`, `Community 2`, `Community 3`, `Community 7`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `RentalStatus` connect `Community 5` to `Community 1`, `Community 2`, `Community 3`, `Community 7`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Customer` connect `Community 4` to `Community 1`, `Community 3`, `Community 5`?**
