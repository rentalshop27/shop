...
## Corpus Check
- 92 files · ~99,166 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1334 nodes · 2714 edges · 61 communities (53 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `04936693`
...
Cohesion: 0.06
Nodes (74): RentalTier, calculateReturnDate(), findConflictingRentalForStockSku(), findOpenRentalConflict(), findOpenRentalForStockSku(), hasRentalConflict(), isDateOverlap(), isOpenRental() (+66 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (77): addStockToVariant(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUnusedImages(), cleanupUploadedProductImagePaths(), countRemoteRentalsForProduct(), countRemoteRentalsForStockItem(), countRemoteRentalsForStockSku() (+69 more)
...
Cohesion: 0.07
Nodes (25): [activeStatusDropdownId, setActiveStatusDropdownId], baseSku, count, [currentPage, setCurrentPage], currentProducts, fileInputRef, filteredItems, InventorySummary (+17 more)
...
Cohesion: 0.14
Nodes (16): createRemoteRental(), loadRentals(), mapRentalRow(), RentalRow, customer, deleteQuery, eq, filters (+8 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (9): InventoryControllerPageProps, InventoryPageProps, ProductDraft, emptyProductDraft, emptyStockDraft, NormalizedStockDraft, normalizeProductDraft(), normalizeStockDraft() (+1 more)
...
Cohesion: 0.25
Nodes (11): customer, getTodayString(), makeRental(), makeStockItem(), onUpdateRentalStatus, user, demoFlatStockItemsForRentals, demoRentals (+3 more)
...
Cohesion: 0.25
Nodes (10): FlatStockItem, Product, ProductWithStockSummary, SizeVariant, StockItem, StockItemStatus, StockItemWithProduct, { primaryStatus } (+2 more)
...
## Knowledge Gaps
- **475 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+470 more)
...
- **Why does `uploadProductImages()` connect `Community 3` to `Community 20`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 20`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 48`, `Community 20`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
