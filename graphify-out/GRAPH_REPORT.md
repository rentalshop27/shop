...
## Corpus Check
- 135 files · ~123,198 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1834 nodes · 3604 edges · 87 communities (77 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8767544b`
...
Cohesion: 0.01
Nodes (141): bulkUpdateRemoteDisplayOrder(), ShopSettings, updateRemoteProductFeatured(), activeCustomers, activeSettingsSubTab, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs] (+133 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (59): buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, customer, makeRental(), metrics (+51 more)
...
Cohesion: 0.06
Nodes (41): allocateFineAmount(), createRemoteRental(), createRemoteRentals(), deleteRemoteRental(), loadRentals(), mapRentalRow(), RentalDepositResolutionUpdate, RentalFineUpdate (+33 more)
...
Cohesion: 0.1
Nodes (33): customer, getTodayString(), makeRental(), makeStockItem(), onUpdateRentalStatus, stockItem, user, buildCatalogSizeSummary() (+25 more)
...
Cohesion: 0.06
Nodes (42): loadStockItemsForRentalMapping(), createSignedUrl, createSignedUrlByBucket, deletedIds, deleteFilterQuery, deleteFilters, deleteQuery, eq (+34 more)
...
Cohesion: 0.13
Nodes (37): cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUnusedImages(), cleanupUploadedProductImagePaths(), countRemoteRentalsForStockSku(), createProductImageDisplayUrl(), createProductWithVariants(), createRemoteStockItem() (+29 more)
...
Cohesion: 0.14
Nodes (26): TextField(), canAddMoreDocuments(), canCreateRentalForCustomer(), findPhoneDuplicate(), formatMeasurements(), normalizeThaiPhone(), profileStatusLabel, profileStatusTone (+18 more)
...
Cohesion: 0.08
Nodes (19): InventoryControllerPageProps, InventoryPageProps, ProductDraft, addStockToVariant(), countRemoteRentalsForProduct(), countRemoteRentalsForStockItem(), loadProductsWithStock(), updateRemoteProductPublicVisibility() (+11 more)
...
Cohesion: 0.15
Nodes (14): 🎨 1. ฟีเจอร์ใหม่: Accordion Submenu ใน Sidebar, 🎨 1. ฟีเจอร์ใหม่: Settings Page Redesign (Vertical Tabs Architecture), 💰 2. ระบบ Auto-Pass สรุปเคสไร้มัดจำ และ Extra Fine Workflow, 🌟 2. สิ่งที่หน้า Settings นี้ยังเชื่อมกับของเดิมในระบบ, Application State & Business Logic, Data Access Layer (Remote), Database & Schema, Handoff: สรุปฟีเจอร์ล่าสุด (Global Rental Defaults, Auto-Pass และ Extra Fine) (+6 more)
...
Cohesion: 0.3
Nodes (12): code:bash (supabase migration up), Current Worktree Signals, Handoff: ปรับปรุงหน้ารายชื่อลูกค้า (Customer Profile & KYC Enhancements), Handoff: ถอดระบบซิงก์ Google Sheets และเพิ่มระบบ Export CSV สำหรับรายงาน, Handoff: Shop Roles / Permission Guards / Staff UI Polish, Handoff: ระบบเพิ่มและจัดการพนักงาน (Staff Management), Known Follow-ups, Recommended Next Session (+4 more)
...
## Knowledge Gaps
- **703 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+698 more)
...
- **Why does `uploadProductImages()` connect `Community 14` to `Community 33`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 18` to `Community 33`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `getFriendlyURL()` connect `Community 52` to `Community 33`, `Community 6`?**
