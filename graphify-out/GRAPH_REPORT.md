...
## Corpus Check
- 42 files · ~73,068 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 604 nodes · 1192 edges · 27 communities (22 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1f89168`
...
Cohesion: 0.02
Nodes (66): activeCustomers, [activeTab, setActiveTab], [auditLogs, setAuditLogs], baseSku, [brands, setBrands], [categories, setCategories], [colors, setColors], count (+58 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (56): buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, customer, metrics, stockItem (+48 more)
...
## Knowledge Gaps
- **163 isolated node(s):** `emptyDraft`, `ViewKey`, `StockDraft`, `emptyStockDraft`, `statusOptions` (+158 more)
...
- **Why does `RentalOrder` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 11`, `Community 12`, `Community 14`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `RentalStatus` connect `Community 2` to `Community 3`, `Community 1`, `Community 11`, `Community 4`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Customer` connect `Community 5` to `Community 1`, `Community 2`, `Community 4`, `Community 11`, `Community 12`, `Community 14`?**
