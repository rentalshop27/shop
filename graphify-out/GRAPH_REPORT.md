...
## Corpus Check
- 132 files · ~123,055 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1860 nodes · 3665 edges · 89 communities (82 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0dac9b37`
...
Cohesion: 0.01
Nodes (133): activeCustomers, activeSettingsSubTab, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs], [authUserEmail, setAuthUserEmail], [authUserId, setAuthUserId], authUserIdRef (+125 more)
...
Cohesion: 0.13
Nodes (35): archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CUSTOMER_SUMMARY_SELECT, CustomerDocumentRow, CustomerRow (+27 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (29): TextField(), ShopSummary, handleLogout(), buildGoogleOAuthStartUrl(), getGoogleOAuthCallbackUrl(), getGoogleOAuthClientId(), getGoogleOAuthReturnUrl(), getGoogleOAuthSetupState() (+21 more)

### Community 15 - "Community 15"
Cohesion: 0.1
Nodes (34): CategoryMultiSelectDropdown(), addStockToVariant(), bulkUpdateRemoteDisplayOrder(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), createProductImageDisplayUrl(), createProductWithVariants() (+26 more)
...
Cohesion: 0.13
Nodes (24): customer, makeRental(), metrics, stockItem, customer, rental, stockItem, FlatStockItem (+16 more)
...
Cohesion: 0.13
Nodes (25): canReuseExistingToken, error, refreshToken, supabase, url, authUrl, url, appendResult() (+17 more)
...
Cohesion: 0.09
Nodes (16): InventoryControllerPageProps, InventoryPageProps, countRemoteRentalsForProduct(), countRemoteRentalsForStockItem(), loadProductsWithStock(), updateRemoteStockItemPublicVisibility(), updateRemoteStockItemStatus(), emptyProductDraft (+8 more)

### Community 24 - "Community 24"
Cohesion: 0.13
Nodes (19): demoCustomers, [activeTab, setActiveTab], customerInsights, CustomersPageProps, DraftCustomerDocument, rentalGuard, StatusFilter, customer (+11 more)
...
Cohesion: 0.09
Nodes (23): allocateFineAmount(), deleteRemoteRental(), saveExtraFine(), updateRemoteRentalDeposit(), updateRemoteRentalDepositResolution(), updateRemoteRentalFields(), updateRemoteRentalStatus(), canDeleteRentalGroup() (+15 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (20): alertSpy, availableCostume, CreateRentalsHandler, customer, existingRental, heading, image, makeRental() (+12 more)

### Community 29 - "Community 29"
Cohesion: 0.21
Nodes (6): executeQuotaErrorCallbacks(), getFriendlyURL(), PrecacheStrategy, StrategyHandler, timeout(), toRequest()
...
Cohesion: 0.33
Nodes (14): cleanupUnusedImages(), countRemoteRentalsForStockSku(), createRemoteStockItem(), createRemoteStockItems(), dataURLtoFile(), deleteRemoteStockItem(), loadStockItems(), mapStockItemRow() (+6 more)

### Community 46 - "Community 46"
Cohesion: 0.27
Nodes (4): executeQuotaErrorCallbacks(), StrategyHandler, timeout(), toRequest()

### Community 47 - "Community 47"
Cohesion: 0.2
Nodes (13): allocateForfeitedDeposit(), DepositAllocation, DepositAllocationInput, DepositResolutionDraft, FineAllocation, FineAllocationInput, fromCents(), normalizeCurrencyAmount() (+5 more)
...
Cohesion: 0.24
Nodes (3): getFriendlyURL(), PrecacheStrategy, Strategy
...
Cohesion: 0.18
Nodes (13): 🎨 1. ฟีเจอร์ใหม่: Accordion Submenu ใน Sidebar, 🎨 1. ฟีเจอร์ใหม่: Settings Page Redesign (Vertical Tabs Architecture), 🌟 2. สิ่งที่หน้า Settings นี้ยังเชื่อมกับของเดิมในระบบ, Handoff Report: Order Tracking & Explicit Shipping Actions, Handoff Report: Rental Tier Pricing Redesign, Handoff Report: Rentals Page Hybrid Table & UI Redesign, Handoff: Settings Navigation Refactor (Accordion Submenu), Handoff: Settings Page Redesign (+5 more)

### Community 53 - "Community 53"
Cohesion: 0.23
Nodes (8): buildCatalogSizeSummary(), CatalogSizeSummary, customer, stockItems, summary, getInventoryDisplayStatus(), StockItem, StockItemStatus
...
Cohesion: 0.46
Nodes (6): calculateCustomerInsights(), calculateCustomerStarRating(), clamp(), CustomerInsights, formatStarRating(), roundToHalf()
...
Cohesion: 0.25
Nodes (5): customer, insights, newCustomer, riskCustomer, stockItem
...
Cohesion: 0.4
Nodes (4): CatalogDisplayItem, catalogItems, items, user

## Knowledge Gaps
- **711 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+706 more)
...
- **Why does `uploadProductImages()` connect `Community 15` to `Community 11`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 13` to `Community 11`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `deleteGoogleDriveCustomerDocuments()` connect `Community 13` to `Community 11`?**
