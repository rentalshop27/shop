...
## Corpus Check
- 92 files · ~96,250 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1189 nodes · 2466 edges · 56 communities (50 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca8e53c5`
...
Cohesion: 0.08
Nodes (65): findConflictingRentalForStockSku(), findOpenRentalConflict(), findOpenRentalForStockSku(), hasRentalConflict(), isDateOverlap(), isOpenRental(), isOpenRentalStatus(), openRentalStatuses (+57 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (59): InventoryControllerPageProps, InventoryPageProps, InventoryPageContainer(), [currentStockItems, setCurrentStockItems], [isSaving, setIsSaving], stockItems, user, cleanupUnusedImages() (+51 more)
...
Cohesion: 0.06
Nodes (30): availability, availabilityCounts, [availabilityFilter, setAvailabilityFilter], [brandFilter, setBrandFilter], brands, CatalogAvailabilityFilter, CatalogAvailabilityStatus, categories (+22 more)
...
Cohesion: 0.13
Nodes (16): addMonths(), buildDressReportsData(), buildMonthlyDepositSummary(), buildMonthRange(), buildReportsDateRange(), CategoryRevenueSlice, DateRange, DateRangeMode (+8 more)
...
Cohesion: 0.21
Nodes (17): updateShopSettings(), addDocuments(), archiveSelectedCustomer(), ensureCustomerDocumentPreview(), ensureExistingDocumentPreview(), getErrorMessage(), handleAddBrand(), handleAddCategory() (+9 more)

### Community 20 - "Community 20"
Cohesion: 0.26
Nodes (9): StockItem, StockItemStatus, demoRentals, demoStockItemsForRentals, RentalOrder, customer, stockItem, supabase (+1 more)
...
Cohesion: 0.13
Nodes (15): buildGeneralStoreMetrics(), buildMonthlyRevenueTrends(), buildRevenueByCategory(), accessoryRental, accessoryStock, activeDateRange, customer, [dressReport] (+7 more)
...
Cohesion: 0.29
Nodes (11): Customer, createRemoteRental(), createRemoteRentals(), deleteRemoteRental(), loadRentals(), mapRentalRow(), RentalRow, toRentalInsert() (+3 more)
...
## Knowledge Gaps
- **390 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+385 more)
...
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 16`?**
