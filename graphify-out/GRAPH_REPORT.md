...
## Corpus Check
- 133 files · ~121,879 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1808 nodes · 3561 edges · 89 communities (78 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b9757b8`
...
Cohesion: 0.06
Nodes (28): [activeStatusDropdownId, setActiveStatusDropdownId], baseSku, count, current, [currentPage, setCurrentPage], currentProducts, fileInputRef, filteredItems (+20 more)
...
Cohesion: 0.11
Nodes (29): bulkUpdateRemoteDisplayOrder(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), countRemoteRentalsForStockItem(), createProductImageDisplayUrl(), createProductWithVariants(), createSignedStorageUrl() (+21 more)
...
Cohesion: 0.09
Nodes (15): InventoryPageProps, addStockToVariant(), countRemoteRentalsForProduct(), loadProductsWithStock(), updateRemoteStockItemPublicVisibility(), updateRemoteStockItemStatus(), emptyProductDraft, emptyStockDraft (+7 more)
...
Cohesion: 0.13
Nodes (22): handleRefundDeposit(), alertSpy, availableCostume, CreateRentalsHandler, customer, existingRental, heading, image (+14 more)
...
Cohesion: 0.15
Nodes (13): buildCatalogSizeSummary(), CatalogSizeSummary, customer, stockItems, summary, getInventoryDisplayStatus(), Product, ProductDraft (+5 more)

### Community 33 - "Community 33"
Cohesion: 0.26
Nodes (17): cleanupUnusedImages(), countRemoteRentalsForStockSku(), createRemoteStockItem(), createRemoteStockItems(), dataURLtoFile(), deleteRemoteStockItem(), loadShopSettings(), loadStockItems() (+9 more)
...
Cohesion: 0.26
Nodes (11): buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, customer, makeRental(), metrics (+3 more)
...
Cohesion: 0.22
Nodes (12): allocateForfeitedDeposit(), DepositAllocation, DepositAllocationInput, DepositResolutionDraft, FineAllocation, FineAllocationInput, fromCents(), normalizeCurrencyAmount() (+4 more)

### Community 47 - "Community 47"
Cohesion: 0.22
Nodes (9): customer, rental, stockItem, FlatStockItem, demoFlatStockItemsForRentals, demoRentals, demoStockItemsForRentals, RentalOrder (+1 more)
...
## Knowledge Gaps
- **688 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+683 more)
...
- **Why does `uploadProductImages()` connect `Community 16` to `Community 35`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 35`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `deleteGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 35`?**
