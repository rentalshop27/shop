# Graph Report - Precious-Shop-Test  (2026-07-04)

## Corpus Check
- 95 files · ~100,159 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1354 nodes · 2750 edges · 61 communities (54 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e2959cb`
...
Cohesion: 0.07
Nodes (63): canCreateRentalForCustomer(), allCostumesHaveSelectedTier, [basePriceFromTier, setBasePriceFromTier], [collectedAmount, setCollectedAmount], costumeContainerRef, costumeImageUrl, [costumeSearch, setCostumeSearch], [currentPage, setCurrentPage] (+55 more)
...
Cohesion: 0.06
Nodes (37): createSignedUrl, createSignedUrlByBucket, deletedIds, deleteFilterQuery, deleteFilters, deleteQuery, eq, file (+29 more)
...
Cohesion: 0.12
Nodes (22): getInventoryDisplayStatus(), FlatStockItem, Product, ProductDraft, ProductWithStockSummary, SizeVariant, StockItem, StockItemStatus (+14 more)
...
Cohesion: 0.17
Nodes (22): cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), createProductImageDisplayUrl(), createProductWithVariants(), createSignedStorageUrl(), deleteRemoteProduct(), deleteShopHeroImage() (+14 more)
...
Cohesion: 0.13
Nodes (18): createRemoteRental(), loadRentals(), mapRentalRow(), RentalRow, customer, deleteQuery, eq, filters (+10 more)
...
Cohesion: 0.15
Nodes (14): 1. Database & Migrations, 2. TypeScript Types & Core APIs, 2. TypeScript Types & Core Rules, 3. API & Controller, 3. User Interface (UI Redesign), 4. Application State (`App.tsx`), 4. User Interface (UI Redesign), 5. Catalog & Customer View (+6 more)
...
## Knowledge Gaps
- **489 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+484 more)
...
- **Why does `uploadProductImages()` connect `Community 18` to `Community 24`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 48`, `Community 24`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 24`?**
