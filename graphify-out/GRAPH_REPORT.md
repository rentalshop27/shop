...
## Corpus Check
- 34 files · ~66,549 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 499 nodes · 1029 edges · 24 communities (20 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dfe66001`
...
5. `RentalOrder` - 14 edges
6. `handleSaveCustomer()` - 13 edges
7. `Router` - 12 edges
8. `StockItem` - 12 edges
9. `normalizeThaiPhone()` - 12 edges
10. `RentalStatus` - 12 edges
...
Cohesion: 0.08
Nodes (47): findOpenRentalConflict(), findOpenRentalForStockSku(), [collectedAmount, setCollectedAmount], costumeContainerRef, [costumeSearch, setCostumeSearch], [currentPage, setCurrentPage], customerContainerRef, [customerSearch, setCustomerSearch] (+39 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (38): [activeContactUser, setActiveContactUser], [activeSlipToReview, setActiveSlipToReview], BankSlip, dynamicRevenue, [extraRevenue, setExtraRevenue], handleApproveSlip(), handleMarkPickedUp(), handleMarkReturned() (+30 more)
...
## Knowledge Gaps
- **102 isolated node(s):** `emptyDraft`, `ViewKey`, `StockDraft`, `emptyStockDraft`, `statusOptions` (+97 more)
...
- **Why does `RentalOrder` connect `Community 3` to `Community 0`, `Community 2`, `Community 5`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `RentalStatus` connect `Community 3` to `Community 0`, `Community 2`, `Community 5`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Customer` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`?**
