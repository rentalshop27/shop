...
## Corpus Check
- 135 files · ~124,185 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1853 nodes · 3632 edges · 92 communities (84 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f002586`
...
Cohesion: 0.01
Nodes (139): bulkUpdateRemoteDisplayOrder(), updateRemoteProductFeatured(), activeCustomers, activeSettingsSubTab, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs], [authUserEmail, setAuthUserEmail] (+131 more)
...
Cohesion: 0.17
Nodes (31): deleteShopHeroImage(), getPathFromUrl(), removeShopAssetPaths(), updateShopSettings(), uploadShopHeroImage(), getErrorMessage(), archiveSelectedCustomer(), cloneRentalPriceTiers() (+23 more)
...
Cohesion: 0.12
Nodes (26): cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), createProductImageDisplayUrl(), createProductWithVariants(), createSignedStorageUrl(), DEFAULT_SHOP_RENTAL_PRICES, deleteRemoteProduct() (+18 more)

### Community 20 - "Community 20"
Cohesion: 0.13
Nodes (24): createRemoteRental(), createRemoteRentals(), deleteRemoteRental(), loadRentals(), mapRentalRow(), RentalDepositResolutionUpdate, RentalFineUpdate, RentalRow (+16 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (15): InventoryControllerPageProps, InventoryPageProps, addStockToVariant(), countRemoteRentalsForProduct(), countRemoteRentalsForStockItem(), updateRemoteStockItemStatus(), emptyProductDraft, emptyStockDraft (+7 more)
...
Cohesion: 0.16
Nodes (22): getLocalDateString(), [activeContactUser, setActiveContactUser], [activeSlipToReview, setActiveSlipToReview], BankSlip, dynamicRevenue, [extraRevenue, setExtraRevenue], handleApproveSlip(), handleMarkPickedUp() (+14 more)
...
Cohesion: 0.09
Nodes (21): aggregatedMetrics, allRentals, failedShopsData, getShopMetrics(), [isLoggingOut, setIsLoggingOut], [logoutError, setLogoutError], metrics, MultiShopDashboardPageProps (+13 more)
...
Cohesion: 0.13
Nodes (16): Product, ProductDraft, ProductWithStockSummary, SizeVariant, StockDraft, StockItemStatus, StockItemWithProduct, displayStatusLabels (+8 more)

### Community 30 - "Community 30"
Cohesion: 0.2
Nodes (19): archiveRemoteCustomer(), createRemoteCustomer(), CustomerDocumentRow, CustomerRow, deleteRemoteCustomerDocuments(), loadCustomers(), loadOwnerShopId(), mapCustomerRow() (+11 more)
...
Cohesion: 0.22
Nodes (10): customer, rental, stockItem, FlatStockItem, demoFlatStockItemsForRentals, demoRentals, demoStockItemsForRentals, RentalOrder (+2 more)
...
Cohesion: 0.27
Nodes (10): buildDashboardMetrics(), getDaysOverdue(), OverdueRental, RentalSchedule, customer, makeRental(), metrics, stockItem (+2 more)
...
Cohesion: 0.17
Nodes (11): depositsCard, draft, field, item, onTogglePublicVisibility, pricedCard, product, productNameInput (+3 more)
...
## Knowledge Gaps
- **713 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+708 more)
...
- **Why does `uploadProductImages()` connect `Community 19` to `Community 36`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `getFriendlyURL()` connect `Community 59` to `Community 36`, `Community 5`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 25` to `Community 36`?**
