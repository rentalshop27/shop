...
## Corpus Check
- 90 files · ~94,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1143 nodes · 2408 edges · 48 communities (42 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1b9e4a7f`
...
Cohesion: 0.02
Nodes (106): activeCustomers, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs], [authUserEmail, setAuthUserEmail], [authUserId, setAuthUserId], authUserIdRef, [availableShops, setAvailableShops] (+98 more)
...
Cohesion: 0.08
Nodes (22): [activeStatusDropdownId, setActiveStatusDropdownId], baseSku, count, fileInputRef, filteredItems, InventorySummary, match, { primaryStatus, nextBookedRental } (+14 more)

### Community 12 - "Community 12"
Cohesion: 0.2
Nodes (14): customer, makeRental(), metrics, stockItem, StockItem, StockItemStatus, demoRentals, demoStockItemsForRentals (+6 more)
...
Cohesion: 0.13
Nodes (22): updateShopSettings(), archiveSelectedCustomer(), closeStockForm(), closeStockPreview(), ensureCustomerDocumentPreview(), ensureExistingDocumentPreview(), getErrorMessage(), handleAddBrand() (+14 more)
...
Cohesion: 0.19
Nodes (11): CatalogDisplayItem, loadPublicCatalog(), PublicCatalogResponse, [error, setError], [items, setItems], PublicCatalogRouteProps, [shopName, setShopName], [status, setStatus] (+3 more)
...
Cohesion: 0.2
Nodes (9): categories, [categoryFilter, setCategoryFilter], CustomerCatalogPageProps, customerReadyItems, date, filteredItems, primaryStatus, [query, setQuery] (+1 more)
...
## Knowledge Gaps
- **357 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+352 more)
