...
## Corpus Check
- 89 files · ~97,215 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1296 nodes · 2666 edges · 55 communities (48 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2529df0`
...
Cohesion: 0.05
Nodes (80): InventoryControllerPageProps, InventoryPageProps, addStockToVariant(), cleanupDeletedProductImagePaths(), cleanupUnusedImages(), cleanupUploadedProductImagePaths(), countRemoteRentalsForProduct(), countRemoteRentalsForStockItem() (+72 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (70): buildDashboardMetrics(), getDaysOverdue(), getLocalDateString(), OverdueRental, RentalSchedule, customer, makeRental(), metrics (+62 more)
...
Cohesion: 0.09
Nodes (53): [basePriceFromTier, setBasePriceFromTier], [collectedAmount, setCollectedAmount], costumeContainerRef, costumeImageUrl, [costumeSearch, setCostumeSearch], [currentPage, setCurrentPage], customerContainerRef, [customerSearch, setCustomerSearch] (+45 more)
...
Cohesion: 0.18
Nodes (11): Product, ProductDraft, ProductWithStockSummary, RentalTier, SizeVariant, StockItemStatus, StockItemWithProduct, { primaryStatus } (+3 more)
...
Cohesion: 0.29
Nodes (7): FlatStockItem, StockItem, demoFlatStockItemsForRentals, demoRentals, demoStockItemsForRentals, StockItem, StockItemStatus
...
## Knowledge Gaps
- **451 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+446 more)
...
- **Why does `uploadProductImages()` connect `Community 2` to `Community 16`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 16`, `Community 42`?**
