...
## Corpus Check
- 135 files · ~123,972 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1851 nodes · 3630 edges · 89 communities (80 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `54e6cb23`
...
Cohesion: 0.16
Nodes (25): canAddMoreDocuments(), canCreateRentalForCustomer(), findPhoneDuplicate(), formatMeasurements(), normalizeThaiPhone(), profileStatusLabel, profileStatusTone, resolveInitialProfileStatus() (+17 more)

### Community 16 - "Community 16"
Cohesion: 0.15
Nodes (32): archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CUSTOMER_SUMMARY_SELECT, CustomerDocumentRow, CustomerRow (+24 more)
...
Cohesion: 0.12
Nodes (21): buildCatalogSizeSummary(), CatalogSizeSummary, customer, stockItems, summary, getInventoryDisplayStatus(), Product, ProductWithStockSummary (+13 more)
...
Cohesion: 0.18
Nodes (29): updateShopSettings(), getErrorMessage(), addDocuments(), archiveSelectedCustomer(), cloneRentalPriceTiers(), ensureCustomerDocumentPreview(), ensureExistingDocumentPreview(), fileToDataUrl() (+21 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (26): addStockToVariant(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), countRemoteRentalsForProduct(), createProductImageDisplayUrl(), createProductWithVariants(), createSignedStorageUrl() (+18 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (16): InventoryControllerPageProps, InventoryPageProps, ProductDraft, countRemoteRentalsForStockItem(), loadProductsWithStock(), updateRemoteProductPublicVisibility(), updateRemoteStockItemPublicVisibility(), emptyProductDraft (+8 more)
...
Cohesion: 0.22
Nodes (20): cleanupUnusedImages(), countRemoteRentalsForStockSku(), createRemoteStockItem(), createRemoteStockItems(), dataURLtoFile(), deleteRemoteStockItem(), getPathFromUrl(), loadStockItems() (+12 more)
...
Cohesion: 0.12
Nodes (16): InventoryPageContainer(), [currentStockItems, setCurrentStockItems], [isSaving, setIsSaving], stockItems, user, loadShopSettings(), InventoryControllerOptions, [currentStockItems, setCurrentStockItems] (+8 more)
...
Cohesion: 0.17
Nodes (16): allocateFineAmount(), allocateForfeitedDeposit(), DepositAllocation, DepositAllocationInput, DepositResolutionDraft, FineAllocation, FineAllocationInput, fromCents() (+8 more)
...
Cohesion: 0.15
Nodes (10): customer, rental, stockItem, FlatStockItem, customer, exportDressReportsToCSVMock, rentals, stockItem (+2 more)
...
Cohesion: 0.17
Nodes (13): 🎨 1. ฟีเจอร์ใหม่: Accordion Submenu ใน Sidebar, 📂 1. Database & Schema, 🎨 1. ฟีเจอร์ใหม่: Settings Page Redesign (Vertical Tabs Architecture), 📡 2. Data Access Layer (Remote), 🌟 2. สิ่งที่หน้า Settings นี้ยังเชื่อมกับของเดิมในระบบ, 🖥️ 3. Application State & Business Logic, 🎨 4. User Interface (UI / UX), Handoff: ระบบ Auto-Pass สรุปเคสไร้มัดจำ และ Extra Fine Workflow (+5 more)

### Community 52 - "Community 52"
Cohesion: 0.2
Nodes (12): updateRemoteRentalDeposit(), updateRemoteRentalDepositResolution(), updateRemoteRentalFields(), updateRemoteRentalStatus(), getAllowedRentalEditFields(), handleCancelRental(), handleEditRentalFields(), handleLoadAuditLogs() (+4 more)
...
Cohesion: 0.2
Nodes (10): 🌟 1. ฟีเจอร์ใหม่: ตั้งค่าระบบราคาและค่าปรับเริ่มต้นส่วนกลาง (Global Rental Defaults), 💰 2. ระบบ Auto-Pass สรุปเคสไร้มัดจำ และ Extra Fine Workflow, Application State & Business Logic, Application State & Data Access, Data Access Layer (Remote), Database & Schema, Database & Schema, Handoff: สรุปฟีเจอร์ล่าสุด (Global Rental Defaults, Auto-Pass และ Extra Fine) (+2 more)
...
Cohesion: 0.29
Nodes (6): customer, draft, onApproveCustomerDocuments, onRiskChange, onStatusChange, selectedCustomer
...
## Knowledge Gaps
- **712 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+707 more)
...
- **Why does `uploadProductImages()` connect `Community 23` to `Community 33`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `getFriendlyURL()` connect `Community 57` to `Community 33`, `Community 6`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 16` to `Community 33`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
