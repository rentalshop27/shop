...
## Corpus Check
- 135 files · ~123,776 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1850 nodes · 3629 edges · 88 communities (77 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae86abd7`
...
Cohesion: 0.01
Nodes (137): updateRemoteProductFeatured(), activeCustomers, activeSettingsSubTab, [activeStatusDropdownId, setActiveStatusDropdownId], [activeTab, setActiveTab], [auditLogs, setAuditLogs], [authUserEmail, setAuthUserEmail], [authUserId, setAuthUserId] (+129 more)
...
Cohesion: 0.13
Nodes (34): archiveRemoteCustomer(), cleanupUploadedCustomerDocumentPaths(), createFunctionError(), createGoogleDrivePreviewUrl(), createRemoteCustomer(), CUSTOMER_SUMMARY_SELECT, CustomerDocumentRow, CustomerRow (+26 more)
...
Cohesion: 0.13
Nodes (37): updateShopSettings(), getErrorMessage(), updateRemoteRentalDepositResolution(), addDocuments(), archiveSelectedCustomer(), cloneRentalPriceTiers(), closeStockForm(), closeStockPreview() (+29 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (33): addMonths(), buildDateRangeFromDates(), buildDressReportsData(), buildGeneralStoreMetrics(), buildMonthlyDepositSummary(), buildMonthlyRevenueTrends(), buildMonthRange(), buildReportsDateRange() (+25 more)
...
Cohesion: 0.1
Nodes (31): addStockToVariant(), bulkUpdateRemoteDisplayOrder(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), createProductImageDisplayUrl(), createProductWithVariants(), createSignedStorageUrl() (+23 more)
...
Cohesion: 0.09
Nodes (16): InventoryControllerPageProps, InventoryPageProps, ProductDraft, countRemoteRentalsForProduct(), countRemoteRentalsForStockItem(), updateRemoteProductPublicVisibility(), updateRemoteStockItemStatus(), emptyProductDraft (+8 more)
...
Cohesion: 0.12
Nodes (23): handleRefundDeposit(), alertSpy, availableCostume, CreateRentalsHandler, customer, existingRental, heading, image (+15 more)
...
Cohesion: 0.15
Nodes (4): createCacheKey(), isArray(), PrecacheController, waitUntil()
...
- **Why does `uploadProductImages()` connect `Community 20` to `Community 34`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 13` to `Community 34`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `getFriendlyURL()` connect `Community 29` to `Community 34`, `Community 58`, `Community 6`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
