...
## Corpus Check
- 114 files · ~112,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1523 nodes · 3047 edges · 73 communities (65 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be83a0a4`
...
8. `saveShopSettings()` - 16 edges
9. `FlatStockItem` - 16 edges
...
- `updateRentalGroupStatus()` --calls--> `onUpdateRentalStatus`  [INFERRED]
  src/features/calendar/CalendarPage.tsx → src/features/rentals/RentalsPage.test.tsx
...
Cohesion: 0.09
Nodes (41): additionalURLs, addRoute(), cacheMatchIgnoreParams(), _cacheNameDetails, cacheNames, cacheWillUpdate(), canConstructResponseFromBodyStream(), cleanupOutdatedCaches() (+33 more)
...
Cohesion: 0.11
Nodes (21): buildCatalogSizeSummary(), CatalogSizeSummary, customer, stockItems, summary, getInventoryDisplayStatus(), Product, ProductDraft (+13 more)
...
Cohesion: 0.14
Nodes (22): addStockToVariant(), cleanupDeletedProductImagePaths(), cleanupDeletedProductImageRefs(), cleanupUploadedProductImagePaths(), countRemoteRentalsForProduct(), createProductImageDisplayUrl(), createProductWithVariants(), deleteRemoteProduct() (+14 more)
...
Cohesion: 0.16
Nodes (18): alertSpy, availableCostume, CreateRentalsHandler, customer, existingRental, heading, image, makeRental() (+10 more)

### Community 24 - "Community 24"
Cohesion: 0.1
Nodes (10): countRemoteRentalsForStockItem(), loadProductsWithStock(), updateRemoteProductPublicVisibility(), updateRemoteStockItemPublicVisibility(), emptyProductDraft, emptyStockDraft, NormalizedStockDraft, normalizeProductDraft() (+2 more)

### Community 25 - "Community 25"
Cohesion: 0.18
Nodes (17): [brandError, setBrandError], [brandSuccess, setBrandSuccess], [categoryError, setCategoryError], [categorySuccess, setCategorySuccess], [colorError, setColorError], [colorSuccess, setColorSuccess], handleAddBrandSubmit(), handleAddCategorySubmit() (+9 more)

### Community 26 - "Community 26"
Cohesion: 0.11
Nodes (20): createRemoteRentals(), deleteRemoteRental(), updateRemoteRentalDeposit(), updateRemoteRentalDepositResolution(), updateRemoteRentalFields(), updateRemoteRentalStatus(), canDeleteRentalGroup(), getAllowedRentalEditFields() (+12 more)
...
Cohesion: 0.26
Nodes (10): FlatStockItem, createRemoteRental(), loadRentals(), mapRentalRow(), RentalDepositResolutionUpdate, RentalFineUpdate, RentalRow, toRentalInsert() (+2 more)
...
## Knowledge Gaps
- **579 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+574 more)
...
- **Why does `uploadProductImages()` connect `Community 21` to `Community 29`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `uploadGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 29`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 29`?**
