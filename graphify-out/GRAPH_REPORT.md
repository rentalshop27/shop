# Graph Report - Precious-Shop-Test  (2026-06-30)

## Corpus Check
- 93 files · ~97,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1206 nodes · 2500 edges · 56 communities (50 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7e1c27ab`
...
Cohesion: 0.07
Nodes (55): InventoryControllerPageProps, InventoryPageProps, cleanupUnusedImages(), countRemoteRentalsForStockSku(), createRemoteStockItem(), createRemoteStockItems(), createSignedStorageUrl(), dataURLtoFile() (+47 more)
...
Cohesion: 0.05
Nodes (38): [activeStatusDropdownId, setActiveStatusDropdownId], baseSku, count, fileInputRef, filteredItems, InventorySummary, match, { primaryStatus, nextBookedRental } (+30 more)
...
Cohesion: 0.05
Nodes (31): availability, availabilityCounts, [availabilityFilter, setAvailabilityFilter], [brandFilter, setBrandFilter], brands, canEditHeroBackground, CatalogAvailabilityFilter, CatalogAvailabilityStatus (+23 more)
...
Cohesion: 0.15
Nodes (18): getInventoryDisplayStatus(), item, itemRepair, itemWash, makeRental(), makeStockItem(), rentals, rentalsActive (+10 more)
...
Cohesion: 0.11
Nodes (6): createCacheKey(), isArray(), isArrayOfClass(), NavigationRoute, PrecacheController, waitUntil()
...
Cohesion: 0.16
Nodes (20): loadCustomerDocumentPreview(), updateShopSettings(), archiveSelectedCustomer(), ensureCustomerDocumentPreview(), ensureExistingDocumentPreview(), fileToDataUrl(), getErrorMessage(), handleAddBrand() (+12 more)
...
## Knowledge Gaps
- **397 isolated node(s):** `url`, `baseClient`, `response`, `headers`, `response` (+392 more)
...
- **Why does `deleteGoogleDriveCustomerDocuments()` connect `Community 1` to `Community 24`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `createGoogleDrivePreviewUrl()` connect `Community 1` to `Community 24`, `Community 20`?**
